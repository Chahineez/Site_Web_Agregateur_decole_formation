  ...
  public function media()
  {
    ...
    <div class="brdr bgc-fff pad-10 box-shad btm-mrg-20 property-listing">
        <div class="media">
            ...
            <img alt="image" class="img-responsive" src="diapo1.jpg"></a>
            ...
            <div class="media-body fnt-smaller">
                ...
                <h4 class="media-heading">
                  <a href="#" target="_parent"> 75,000 DA <small class="pull-right">Formation php</small></a></h4>


                <ul class="list-inline mrg-0 btm-mrg-10 clr-535353">
                    <li>1.000 DA par heure</li>
                ...
                <p class="hidden-xs"> Formation avancée en php avec les meilleurs formateurs en Algérie ....
                ...</p><span class="fnt-smaller fnt-lighter fnt-arial">Alger Delly Brahim</span>
            </div>
        </div>
    </div><!-- End Listing-->
    </div>
  ...
  <table id="table-a-trier">
    <thead>
      <tr>
        ...
        <th data-sort="string">Domaine<i class="fa fa-sort"></i></th>
        <th data-sort="string">Wilaya<i class="fa fa-sort"></i></th>
        <th data-sort="string">Commune<i class="fa fa-sort"></i></th>
        <th data-sort="string">Address<i class="fa fa-sort"></i></th>
        <th data-sort="string">Tel<i class="fa fa-sort"></i></th>
        <th data-sort="string">Fax<i class="fa fa-sort"></i></th>
        <th scope="col" > </th>
      </tr>
    </thead>
    <tbody id="myTable">';
    foreach ($array as $row => $ecole)
    {
         echo '
          <tr>
               ...
               <td>'.$ecole["tel"]. '</td>
               <td>'.$ecole["fax"]. '</td>
               <td><a id ="'.$ecole["id"].'" href="commentaire.php?id_ecole= '.$ecole["id"]; echo '&nom_ecole= '.$ecole["nom"].'" > <input  class="btn btn-primary" type="button" value="commenter"></a></td>
          </tr>
         ';
    }
    echo '
